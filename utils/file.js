...
/**
 * FilesCollection class use to manage file documents
 */
export class FilesCollection {
  ...
  /**
   * Async function that search for a document by its ID.
   *
   * @param {string} id - The ID of the document to search.
   ...
   *
   * @param {Object} file - The file to be included to the database.
  ...
  /**
   * Finds a user file by the id.
   *
   * @param {string} userId - Id of the user.
   * @param {string} fileId - Id of the file.
   * @param {boolean} [removeLocalPath=true] - Either nor to remove the
   * local path.
  ...
  /**
   * Asynchronously finds and returns a file whether it is public or it is owned
   * by a given user.
   *
   * @param {string} userId - ID of the user
   * @param {string} fileId - ID of the file
  ...
  /**
   * Finds all files assigned to a user that has a specific parentId.
   *
   * @param {string} userId - ID of the user to lookout files for.
   * @param {string} parentId - ID of the parent file to search for.
  ...
  /**
   * Updates a file's publish status for a given user.
   *
   * @param {string} userId - ID of the user who owns the file published
   * @param {string} fileId - ID of the file to update.
   * @param {boolean} isPublished - New publication status of the file.
  ...
  /**
   * Replacing the default MongoDB _id field with a new 'id' field in the given
   * document object.
   *
   * @param {Object} document - Object showing a MongoDB document.
   * @return {Object} An object with the '_id' field that has been replaced by a new 'id'
   * field.
   */
  ...
  /**
   * Removes the localPath property from a document.
   *
   * @param {Object} document - Document object to remove localPath property
   * from.
   * @return {Object} Thenew document object without the localPath property.
   */
...
/**
 * File class that shows a file document
 */
export default class File {
  ...
  /**
   * Asynchronously validates the object and returns an error alert if
   * invalid.
   *
  ...
  /**
   * Asynchronously saving data to the database.
   *
