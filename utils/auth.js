...
/**
 * The email and password are retrieve from a basic auth token provided in the
 * Authorization header of a request.
 *
 * @param {Object} request - Request containing the authorization header.
...
/**
 * Returns the token session from the request header (x-token).
 *
 * @param {Object} request - Request object containing the headers.
...
/**
 * Authenticates based on email and password of a user
 *
...
/**
 * Generates a session token for the given user ID and keep it in Redis for
 * 24 hours.
 *
 * @param {string} userId - User id for whom the session is being generated.
...
/**
 * Deletes a session token from Redis and returns indicating success.
 *
 ...
 *
 * @param {string} token - Session token to retrieve user data from.
 ...
 *
 * @param {Object} request - Request object that contains the session token.
